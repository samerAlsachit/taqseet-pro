    ...
    <div className="min-h-screen bg-gray-bg">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-20">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <h1 className="text-xl font-bold text-navy">تقسيط برو</h1>
          <div className="flex items-center gap-4">
            <span className="text-sm text-text-primary hidden sm:inline">{storeName}</span>
            <button
              onClick={handleLogout}
              className="text-text-primary hover:text-danger transition"
            >
              🚪
            </button>
          </div>
        ...
        <div className="fixed inset-0 z-30 lg:hidden">
          ...
          <aside className="absolute right-0 top-0 h-full w-64 bg-navy shadow-lg">
            <div className="p-4 border-b border-white/10">
              <h2 className="text-white text-xl font-bold">تقسيط برو</h2>
      ...
      <div className="hidden lg:flex">
        <aside className="w-64 bg-navy min-h-screen sticky top-0">
          <div className="p-6 border-b border-white/10">
            <h2 className="text-white text-2xl font-bold">تقسيط برو</h2>
            <p className="text-white/60 text-sm mt-1">{storeName}</p>
          </div>
          <nav className="p-4">
            {navItems.map((item) => (
